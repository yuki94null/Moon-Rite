...
execute if score @s yrh013.global matches 50.. store result storage yrh.013:global tmp.Index int 1.0 run scoreboard players set @s yrh013.global 50


## フレームに従って処理

function yrh.013:item/ability/ingetsu/target/item_display/.root with storage yrh.013:global tmp
